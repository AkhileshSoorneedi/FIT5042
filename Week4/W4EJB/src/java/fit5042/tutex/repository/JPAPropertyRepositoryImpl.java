...
public class JPAPropertyRepositoryImpl implements PropertyRepository {
    ...
    @PersistenceContext(name = "W4EJBPU")//insert code (annotation) here to use container managed entity manager to complete these methods  
    ...
    public List<Property> searchPropertyByBudget(double budget) throws Exception {
        ...
        Predicate condition = cb.le(r.get("price").as(Double.class), budget);
        q.where(condition);
        TypedQuery<Property> tq = entityManager.createQuery(q);
